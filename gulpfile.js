...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new becker name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/becker.png')) {
        fs.renameSync(__dirname + '/admin/becker.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/becker.html')) {
        fs.renameSync(__dirname + '/widgets/becker.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/becker/js/becker.js')) {
        fs.renameSync(__dirname + '/widgets/becker/js/becker.js', __dirname + '/widgets/becker/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/becker')) {
        fs.renameSync(__dirname + '/widgets/becker',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /becker/g,
        ...
        {
            match: /Becker/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Becker'
        },
        {
            match: /Markus Hofmann/g,
            replacement: author
        },
        {
